...
Первое поле открывает окно настроек патогенной мутации для внесения строки в базы мутаций, второе поле включает мутацию в [отчет](report.md). В поле __hg38__ отображается информация о геномной координате и количестве инструментов, обнаруживших данный вариант &ndash; максимальной надежностью обладают варианты с двумя отметками. Нажатием на ссылку с координатой открывается [геномный браузер IGV](#igv).

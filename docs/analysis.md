...
Флаги Freq и OR могут использоваться в качестве индикатора технических артефактов &ndash; если встречаемость варианта аномально высока (например, он найден у 80 образцов из 100 в проекте, но при этом не встречается в gnomAD), то скорее всего такой вариант возник из-за особенностей процесса подготовки библиотек или процесса секвенирования и он не является вариантом, присутствующим в геноме образца.

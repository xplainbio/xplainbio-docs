...
Блок частот показывает частоты для геномов и экзомов из gnomAD (по ссылке можно перейти на страницу базы данных), а также подсчитывает встречамость варианта в проекте. Доступен поиск варианта как в текущем проекте, так и в других проектах пользователя.

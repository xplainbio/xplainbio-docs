...
Верхний левый блок отображает геномные аннотации с возможностью копирования, в дополнение к аннотации в таблице показывает значение QUAL из VCF, а также список инструментов, которые обнаружили данный вариант.

...
* Варианты с частотой в геномах gnomAD менее 5%

Фильтры можно комбинировать в любых сочетаниях, также доступна сортировка по полям "hg38", "Ген" и "RD", использование предварительной фильтрации позволяет снизить число анализируемых вариантов в десятки раз и значительно ускорить интерпретацию образцов.

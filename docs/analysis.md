...
Для просмотра детальной информации о варианте необходимо кликнуть на любое поле строки таблицы аннотаций &ndash; открывшаяся страница содержит несколько блоков с подробными данными о выбранной замене.
